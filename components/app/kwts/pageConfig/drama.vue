  ...
  <div class="cool">
    ...
    <Form
      ...
      <!-- <FormItem label="单曲id" required prop="id">
        <Input v-model="formData.id" type="number"/>
      </FormItem> -->
      <FormItem label="单曲id" required prop="id">
      ...
      <FormItem label="albumType" prop="albumType">
        <Input v-model="formData.albumType"/>
      </FormItem>

      <FormItem label="介绍" required prop="rec">
        <Input v-model="formData.rec"/>
      </FormItem>
      <FormItem label="模块按钮" prop="btn">
        <Checkbox v-model="formData.btn" true-value="http://h5static.kuwo.cn/tsConfig/1604907764493.png" false-value="">
            <img src="http://h5static.kuwo.cn/tsConfig/1604907764493.png" alt="">
        </Checkbox>
        <div class="msg">
          注：这是透明图片，为看出效果，附加了 黑色/绿色 背景和边框。<br>
          绿色为选中，则显示按钮，背景如此图。黑色为不显示按钮
        </div>
      </FormItem>
      <FormItem>
